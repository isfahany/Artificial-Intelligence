...
/**
 * This class implements a Backtracking search to find a solution to a CSP
 * Problem.
 */
public class Backtrack {
    ...
    /**
     * Starts the Backtracker given a problem and a specific assignment.
     */
     ...
     * Solves the problem.
     *
     * @return An assignment that satisfies all constraints or null if none is
     * found.
     */
    ...
    /**
     * Returns an assigned variable to try to assign. This can be sub-classed to
     * add heuristics.
     */
    ...
    /**
     * Returns an ordered list of values to try to assign. May be sub-classed to
     * add heuristics.
     */

...
/**
 * This class represents an abstract "problem". A problem is anything that can
 * be modeled in as a CSP.
 */
public abstract class CSPProblem {

    /**
     * Map that stores the constraints on any given variable.
     */
    ...
    /**
     * Returns a list of potential domain values for a varaible. This can be
     * sub-classed to add heuristics.
     */
    ...
    /**
     * Returns if the new variable assignment is consistent. This can be
     * sub-classed to add heuristics.
     */
    ...
    /**
     * Returns a new assignment based on some inferences. This can be
     * sub-classed to add heuristics.
     */
